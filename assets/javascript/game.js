...
var guessesRemaining = computerChoice.length+2;
...
// ex: coldplay = 8 chars 
// coldplay is the computerChoice. 8 is computerChoice.length

var computerChoiceText = document.getElementById("computerChoice");
computerChoiceText.textContent = "_ ".repeat(computerChoice.length);
